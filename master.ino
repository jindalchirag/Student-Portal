...
const char *ssid = "Yogesh Ji";  //ENTER YOUR WIFI SETTINGS
const char *password = "yogeshji";

//Web/Server address to read/write from 
const char *host = "192.168.43.32";   //IP address of server
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  Link = "http://192.168.43.32/minor/postdemo.php" + getData;
